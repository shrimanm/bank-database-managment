...
if (isset($_POST['fname'])) {
    ...
    $sql = "INSERT INTO `bank`.`eaccount` (`photo`,`accno`,`fname`, `mname`, `lname`, `dob`, `age`, `gender`, `phoneno`, `email`, `martial`, `address`, `city`, `district`, `state`, `pincode`, `nationality`, `adharid`, `panid`, `fathername`, `mothername`, `date`,`balance`) VALUES ('$photo','$accno','$fname', '$mname', '$lname', '$dob', '$age', '$gender', '$phno', '$email', '$martial', '$address', '$city', '$district', '$state', '$pincode', '$nationality', '$adharid', '$panid', '$fathername', '$mothername', current_timestamp(),'$balance');";
...
<body>
    ...
    <nav>
        <ul>
            ...
            <li class="home h6"><a href="createEA.php">create Eaccount</a></li>
    ...
    <section>
        ...
        ?>
        <form action="" method="post" class="h6">
            <div class="1">
            ...
            <div class="8">
                <div class="a"><label for="photo">Upload Photo : <?php echo "<=1MB"; ?> </label>
                    ...
                    <hr>
                    <div class="a"><input type="submit" value="Submit" name="submit"></div>
                </div>
