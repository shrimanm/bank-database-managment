...
if (isset($_POST['edited'])) {
    ...
    $sql = "UPDATE `bank`.`eaccount` SET `fname`='$fname', `mname`='$mname', `lname`='$lname', `dob`='$dob', `age`='$age', `gender`='$gender', `phoneno`='$phoneno', `email`='$email', `martial`='$martial', `address`='$address', `city`='$city', `district`='$district', `state`='$state', `pincode`='$pincode', `nationality`='$nationality', `fathername`='$fathername', `mothername`='$mothername' WHERE `bank`.`eaccount`.`accno`='$accno';";
...
<body>
    <nav>
        <ul>
            ...
            <li class="h6 home"><a href="employeeD.php">employee details</a></li>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-secondary">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            <form action="" method="post">
                <button class="btn btn-warning btn-lg p-2 m-2" onclick="">Enter Employee Account Number</button><input class="btn btn-light btn-lg p-1 m-3" type="number" name="accno" placeholder=" Enter Acc no."><br>
