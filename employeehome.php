...
<body>
    <nav>
        <ul>
            ...
            <li class="home h6"><a href="employeehome.php">Home</a></li>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-secondary">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            <h1 class="display-4 fw-normal">Welcome Employee</h1>
            <p class="lead fw-normal">And an even wittier subheading to boot. Jumpstart your marketing efforts with this example based on Apple’s marketing pages.</p>
            <form action="" method="post">
                <input type="submit" name="submit" value="check My account details" class="btn btn-outline-warning"><br><br>
